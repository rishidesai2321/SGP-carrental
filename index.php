      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1 class="style1">FIND THE RIGHT </h1>
			<h1 class="style1"> <font color="BLACK"> CAR FOR YOU </font> </h1>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2><font color="#FF0000">Find the Best</font> <span>CarForYou</span></h2>
       </div>
    <div class="row"> 
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2> <font color="lightgreen"> Our Satisfied Customers </font></h2>
	  
	  <h2> Ritesh Ponkiya </h2>
	  <h2> Shreyash Pethani </h2>
	  <h2> Yash Soni </h2>
	  <h2> Bera Abhi </h2>
